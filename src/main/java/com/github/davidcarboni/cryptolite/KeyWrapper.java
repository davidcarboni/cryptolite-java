 ...
 * (which can be generated by calling {@link Random#generateSalt()}). The salt
...
public class KeyWrapper implements Serializable {
	 ...
	 * @param salt
	 *            A value for this can be obtained from
	 *            {@link Random#generateSalt()}. You need to store a salt value
	 ...
	 * 
	 * @param key
	 *            The {@link SecretKey} to be wrapped. This method internally
	 ...
	 * 
	 * @param key
	 *            The {@link PrivateKey} to be wrapped. This method internally
	 *            just calls {@link #wrap(Key, String)}, but this provides a
	 ...
	 * 
	 * @param key
	 *            The {@link Key} to be wrapped. This can be a secret
	 *            (symmetric) key or a private (asymmetric) key.
	 * @param wrapAlgorithm
	 *            The algorithm to use to wrap the key. This has to be different
	 ...
	 * @param keyType
	 *            The type of key. This should be a constant from the
	 *            {@link Cipher} class.
	 * @param wrapAlgorithm
	 *            The algorithm to use to unwrap the key. This has to be
